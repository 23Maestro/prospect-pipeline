...
class NpidAutomator:
    ...
    def __init__(self, base_url: str, username: str, password: str) -> None:
        ...
        state_path = os.environ.get("NPID_PLAYWRIGHT_STATE_PATH", "/app/state/playwright_state.json")
        self._storage_path = Path(state_path).expanduser()
        self._storage_path.parent.mkdir(parents=True, exist_ok=True)
        token_path = os.environ.get("NPID_TOKEN_PATH", "/app/state/npid_tokens.json")
