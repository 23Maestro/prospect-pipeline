...
export default function ProspectMobilePage() {
  ...
  return (
    <>
      ...
      <link rel="stylesheet" href="/prospect-mobile/styles.css?v=20260522-search-actions" />
      ...
      />
      <Script type="module" src="/prospect-mobile/app.js?v=20260522-set-meetings-freshness" strategy="afterInteractive" />
    </>
  );
}
