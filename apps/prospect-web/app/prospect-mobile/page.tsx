...
export default function ProspectMobilePage() {
  ...
  return (
    <>
      ...
      <link rel="stylesheet" href="/prospect-mobile/styles.css?v=20260613-schedule-actions-polish" />
      ...
      />
      <Script type="module" src="/prospect-mobile/app.js?v=20260613-schedule-actions-polish" strategy="afterInteractive" />
    </>
  );
}
